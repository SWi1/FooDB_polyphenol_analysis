---
title: "Q1_Polyphenol_Quantification_PhenolID"
...
__Information__  
Wilson and Lemay corresponded with Jose Naveja to obtain phenolic compounds from FooDB (Wilson sent Naveja the version she downloaded Sept 2022). Dr. Naveja identified phenolic compounds using methods outlined in his 2018 paper in FL100 and emailed back the resulting SDF file. 
...
SDF = read_sdf('data/FooDB2_polyphenols_ID.sdf')
...
sum(citation[1:2,2])/sum(citation[,2]) #top 3/total
```
