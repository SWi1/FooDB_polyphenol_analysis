...
__Required Input Files__  
  - *04_scores_auto_manualcheck.csv* - output from 04_FooDB_FNDDS_FullMatch_Part1.Rmd, following the manual addition of a new column of correct/incorrect classifiations.
